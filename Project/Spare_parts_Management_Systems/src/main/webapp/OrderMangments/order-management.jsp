                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex gap-2">
                        <a href="${pageContext.request.contextPath}/order-details?id=${order.orderID}" class="btn btn-outline-primary action-btn">
                          <i class="fas fa-print"></i> Print
                        </a>
                        <a href="${pageContext.request.contextPath}/order-update?id=${order.orderID}" class="btn btn-outline-warning action-btn">
                          <i class="fas fa-edit"></i> Edit
                        </a>
                        <a href="${pageContext.request.contextPath}/order-delete?id=${order.orderID}" class="btn btn-outline-danger action-btn" onclick="return confirm('Are you sure you want to delete this order?')">
