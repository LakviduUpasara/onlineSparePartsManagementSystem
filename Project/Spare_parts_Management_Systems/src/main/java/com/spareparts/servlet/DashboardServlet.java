...
public class DashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("${pageContext.request.contextPath}dashboard.jsp"); // Or Dashbords.jsp
            dispatcher.forward(request, response);
        } catch (Exception e) {
            LOGGER.severe("Unexpected error: " + e.getMessage());
            request.setAttribute("error", "Unexpected error: " + e.getMessage());
            RequestDispatcher dispatcher = request.getRequestDispatcher("${pageContext.request.contextPath}dashboard.jsp"); // Or ManagerDashbord jsp
            dispatcher.forward(request, response);
        }
    }
