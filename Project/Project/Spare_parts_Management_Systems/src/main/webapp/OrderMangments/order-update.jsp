<%-- web/OrderMangments/order-update.jsp --%>
...
<head>
    ...
    <title>Full Trade Support - Update Order</title>
...
<body>
    ...
    <div class="main-content w-100">
        ...
        <div class="dashboard-content">
            ...
            <% } else { %>
                <form action="${pageContext.request.contextPath}/order-update" method="post" id="updateOrderForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="customerId" name="customerId" required>
                            ...
                            %>
                            <option value="<%= customer.getCustomerID() %>" <%= customer.getCustomerID() == order.getCustomerID() ? "selected" : "" %>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="discount" name="discount" value="<%= order.getDiscount() %>" min="0" max="100" required>
                    </div>
                    <div class="mb-3">
                        <h6>Order Items</h6>
                        <div id="orderItems">
                            ...
                            <div class="row mb-2">
                                <div class="col-5">
                                    <select class="form-control item-select" name="itemId[]" required>
                                        ...
                                        %>
                                        <option value="<%= item.getItemID() %>" data-price="<%= item.getSellPrice() %>"
                                                <%= item.getItemID() == detail.getItemID() ? "selected" : "" %>>
                                            <%= item.getItemName() %> (Stock: <%= item.getQty() %>)
                                        </option>
                                        <% } } else { %>
                                ...
                                <div class="col-3">
                                    <input type="number" class="form-control item-qty" name="quantity[]" value="<%= detail.getQuantity() %>" min="1" required>
                                </div>
                                <div class="col-3">
                                    <input type="number" step="0.01" class="form-control item-price" value="<%= detail.getUnitPrice() %>" readonly>
                                </div>
                                <div class="col-1">
                    ...
                    <a href="${pageContext.request.contextPath}/order-management" class="btn btn-secondary">Cancel</a>
                </form>
            <% } %>
        </div>
    </div>
